...
- Với quyết định sản phẩm có nhiều phương án cạnh tranh, dùng skill `/multi-llm-browser-research` để đối chiếu trước khi chốt PRD/user story.
...
- Nếu nhận định còn trái chiều, chạy `/multi-llm-browser-research` để kiểm tra chéo và đưa ra kết luận có cơ sở.
