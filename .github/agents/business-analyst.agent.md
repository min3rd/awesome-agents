...
- Khi có điểm mơ hồ hoặc mâu thuẫn nghiệp vụ, dùng skill `/multi-llm-browser-research` để đối chiếu ChatGPT/Gemini/Grok trước khi chốt nội dung SRS.
...
- Nếu vẫn còn mâu thuẫn giữa các phương án, chạy `/multi-llm-browser-research` và ghi rõ kết luận đối chiếu trong phần ghi chú của SRS.
